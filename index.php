    ...
    <!-- Top Bar
		...
		<div id="top-bar">
			...
			<div class="container clearfix">
				...
				<div class="col_half nobottommargin">
					...
					<div class="top-links">
						<ul>
							<li><a href="http://dieselsellerz.com/diesel"><i class="icomoon-dieselsellerz"></i></a></li>
				...
				<div class="col_half fright col_last nobottommargin">
					...
					<div id="top-social">
						<ul>
							...
							<li><a href="mailto:info@dieselsellerz.com" class="si-email3"><span class="ts-icon"><i class="icon-email3"></i></span><span class="ts-text">info@dieselsellerz.com</span></a></li>
						</ul>
					</div><!-- #top-social end -->
		...
		<header id="header" class="transparent-header dark" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="http://dieselsellerz.com/diesel" class="standard-logo" data-dark-logo="themes/front/images/logo-dark.png"><img src="images/logo.png" alt="DieselSellerz Logo"></a>
						<a href="http://dieselsellerz.com/diesel" class="retina-logo" data-dark-logo="themes/front/images/logo-dark@2x.png"><img src="images/logo@2x.png" alt="DieselSellerz Logo"></a>
					</div><!-- #logo end -->
							...
							<li><a href="#"><div>OUR SITES</div></a>
								<ul>
									<li><a href="#"><div><i class="icomoon-dieselsellerz"></i>SELLERZ</div></a>
										<ul>
											<li><a href="http://dieselsellerz.com/diesel"><div>DieselSellerz</div></a>
											</li>
											<li><a href="http://dieselsellerz.com/jeep/trucks"><div>JeepSellerz</div></a>
											</li>
										</ul>
									</li>
		...
		<section id="slider" class="slider-parallax revoslider-wrap clearfix">
			...
			<div class="tp-banner-container rev_slider_wrapper fullscreen-container">
				<div class="tp-banner" >
						<ul>    <!-- SLIDE  -->
					<li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="themes/front/images/slider/rev/main/s1-thumb.jpg"  data-saveperformance="off"  data-title="We Buy & Sell Diesels">
						<!-- MAIN IMAGE -->
						<img src="images/slider/rev/bg-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
						<!-- LAYERS -->
						...
						<div class="tp-fade fadeout fullscreenvideo rs-background-video-layer"
							...
							data-videomp4="http://sellerz-videos.s3.amazonaws.com/video-bg-1.mp4"
						...
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; text-align: center;">The World's Largest Online Diesel Marketplace</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Welcome to the World of DieselSellerz</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; width: 750px; max-width: 750px; white-space: normal;">Buy, sell, or trade a diesel truck or part. But that's not all we're good for! Check out other ventures by DieselSellerz below. </div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;"><a href="#sites" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>Our Sites</span> <i class="icon-angle-down"></i></a></div>

					</li>
					<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="10000"  data-saveperformance="off">
					<!-- MAIN IMAGE -->
					<img src="/themes/front/images/slider/rev/bg-4.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
					...
					<!-- LAYER NO. 1 -->
						<div class="tp-fade fadeout fullscreenvideo rs-background-video-layer"
							...
							data-videowidth="100%"
							data-videoheight="100%"
							data-videomp4="http://sellerz-videos.s3.amazonaws.com/video-bg-3.mp4"
							data-videopreload="preload"
							data-videoloop="none"
							data-forceCover="1"
							data-aspectratio="16:9"
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Have you heard? We've got our own show on Discovery Channel!</div>
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; line-height: 1.2; max-width: 600px; width: 600px; white-space: normal;">DIESEL BROTHERS Mondays @ 10/9c</div>
					...
					<div class="tp-caption customin ltl tp-resizeme"
						...
						data-endelementdelay="0.1"
						data-endspeed="1300"
						data-endeasing="Power4.easeIn" style="z-index: 11;"><a href="https://www.discoverygo.com/diesel-brothers/" target="_blank" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>Watch Full Episodes</span> <i class="icon-angle-right"></i></a></div>
					...
					<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off">
						<!-- MAIN IMAGE -->
						<img src="images/slider/rev/bg-2.jpg"  alt=""  data-bgposition="left top" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-bgpositionend="right bottom">
						<!-- LAYERS -->
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; white-space: nowrap;">We build badass trucks. And the best part is...</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; font-size: 56px; white-space: nowrap;">WE GIVE THEM AWAY.</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; max-width: 550px; white-space: normal;">Since we started in 2012, we've built and given away over 15 diesels.</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1300"
						data-endeasing="Power4.easeIn" style="z-index: 11;"><a href="#builds" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>See the Trucks</span> <i class="icon-angle-right"></i></a></div>

					</li>
					<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="10000"  data-saveperformance="off">
					<!-- MAIN IMAGE -->
					<img src="images/slider/rev/bg-3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Our builds do more than just look good. See our trucks in action.</div>
					...
					data-endelementdelay="0.1"
					data-endspeed="1000"
					data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; line-height: 1.2; max-width: 500px; width: 500px; white-space: normal;">We Work Hard. We Play Harder.</div>
					...
					<div class="tp-caption customin ltl tp-resizeme"
						...
						data-endelementdelay="0.1"
						data-endspeed="1300"
						data-endeasing="Power4.easeIn" style="z-index: 11;"><a href="http://youtube.com/dieselsellerz" target="_blank" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>Watch Us on YouTube</span> <i class="icon-angle-right"></i></a></div>
			...
			<div class="content-wrap">
				...
				<div id="sites" class="container clearfix">
					...
					<div class="divcenter center clearfix" style="max-width: 900px;">
						...
						<a href="http://dieselsellerz.com/diesel" class="button button-3d button-dark button-large">Browse Diesels</a>
						<a href="http://dieselsellerz.com/jeep/trucks" class="button button-3d button-dark button-large">Browse Jeeps</a>
					</div>
				...
				<div class="section dark parallax notopmargin nobottommargin noborder" style="height: 500px; padding: 200px 0;">
					...
					<div class="video-wrap">
						<video poster="/themes/front/images/slider/rev/bg-4.jpg" preload="none" autoplay muted>
							<source src='http://sellerz-videos.s3.amazonaws.com/video-social.mp4' type='video/mp4' />
						</video>
				...
				<div class="col_full nobottommargin common-height">
					...
					<div class="col-md-4 dark col-padding ohidden" style="background-color: #ff4d4d;">
						<div>
							...
							<a href="http://youtube.com/dieselsellerz" class="button button-border button-light button-rounded uppercase nomargin">Subscribe</a>
				...
				<div class="footer-widgets-wrap clearfix">
					...
					<div class="col_one_third">
						...
						<div class="widget clearfix">
							...
							<div style="background: url('themes/front/images/world-map.png') no-repeat center center; background-size: 100%;">
								<address>
								...
								<abbr title="Email Address"><strong>Email:</strong></abbr> info@dieselsellerz.com
							</div>
					...
					<div class="col_one_third">
						<div id="inquiries" class="widget quick-contact-widget clearfix">
							...
							<form id="quick-contact-form" name="quick-contact-form" action="themes/front/include/quickcontact.php" method="post" class="quick-contact-form nobottommargin">
					...
					<div class="col_one_third col_last">
						...
						<div id ="advertise" class="widget quick-contact-widget clearfix">
							...
							<form id="quick-contact-form" name="quick-contact-form" action="include/advertise.php" method="post" class="quick-contact-form nobottommargin">
